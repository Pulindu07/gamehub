...
export default function MemoryBoard() {
  ...
  if (!isSizeSelected) {
    return (
      <>
        <div className="flex flex-col items-center justify-center min-h-[300px] p-6 gap-6">
          {/* First Row */}
          <div className="w-full text-center">
            <h2 className="text-xl font-bold">Select Grid Size to Start</h2>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center min-h-[300px] p-6 gap-6">
          {/* Second Row: Buttons stacked vertically */}
