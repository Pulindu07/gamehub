    ...
    <div>
      ...
      <div className="container-lg">
            ...
            >
              <div className="flex gap-3 mt-6" style={{ flexWrap: "wrap" }}>
                ...
                <Button
                  ...
                  size="lg"
                  onClick={() => {
                    const invite = createInvite(game.key); // returns { url, gameId }
                    shareWhatsApp(invite.url);
                    navigate(
                      `/game/${game.key}?mode=multiplayer&gameId=${invite.gameId}`
                    );
                  }}
                  className="flex-1"
                >
        ...
        <div className="mt-16 center">
          <h2 className="card-title" style={{ fontSize: 22, marginBottom: 16 }}>
            Why PlayTogether?
          </h2>
          <div
